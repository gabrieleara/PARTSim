...
namespace RTSim {
    ...
    Server::Server(const string &name, const string &s) :
        ...
        last_exec_time(0),
        kernel(0),
        _bandExEvt("Budget exhausted", this, &Server::onBudgetExhausted,
                   Event::_DEFAULT_PRIORITY + 4),
        _dlineMissEvt("Deadline missed", this, &Server::onDlineMiss, Event::_DEFAULT_PRIORITY + 6),
        _rechargingEvt("Recharging", this, &Server::onRecharging,
                       Event::_DEFAULT_PRIORITY - 1),
        _schedEvt("Scheduling", this, &Server::onSched),
        _deschedEvt("Descheduling", this, &Server::onDesched),
        _dispatchEvt("Dispatching", this, &Server::onDispatch, Event::_DEFAULT_PRIORITY + 5),
        sched_(nullptr),
        currExe_(nullptr) {
