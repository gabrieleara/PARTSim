...
namespace RTSim {
    ...
    /**
        ...
        \code
        RandomRTTaskSetFactory<ConstCompGen, ConstArrGen, SporadicDlineGen>
       ts();
    ...
    */
    ...
    public:
        ...
        public:
            ...
            Exc(string ms, string cl = "RandomTaskSetFactory",
                string md = "load.hpp") :
                BaseExc(ms, cl, md) {}
        };
    ...
    */
    ...
    public:
        ...
        ConstIATGen(Tick t1, Tick t2, Tick m = TMIN_DEF, Tick gcd = GCD_DEF) :
            IATGen(t1, t2, m, gcd) {}
        virtual ~ConstIATGen() {}
        bool generate() override;
    };
    ...
    public:
         ...
         */
        UniformIATGen(Tick t1, Tick t2, Tick m = TMIN_DEF, Tick gcd = GCD_DEF,
                      double d = DELTA_DEF) :
            IATGen(t1, t2, m, gcd),
            delta(d) {}
    ...
    public:
        /** @param t1 minimum IAT
            ...
            @param d (optional) the percentage of variation. By defaul, is 0.1
         */
        MaxIATGen(Tick t1, Tick t2, Tick m = TMIN_DEF, Tick gcd = GCD_DEF,
                  double d = DELTA_DEF) :
    ...
    public:
        /** @param t1 minimum IAT
            ...
            @param d (optional) the percentage of variation. By defaul, is 0.1
         */
        MinIATGen(Tick t1, Tick t2, Tick m = TMIN_DEF, Tick gcd = GCD_DEF,
                  double d = DELTA_DEF) :
            UniformIATGen(t1, t2, m, gcd, d) {}
        Tick getMin(int i) const override {
            return getAvg(i);
    ...
    public:
        ...
        /** The computation times are variable, within [max(cmin, c*(1-d),
         * c*(1+d)] and c is computed from the interarrival times.
    ...
    public:
        /** @param c (optional) minimum possible computation time, by default is
         * 1
         *  @param d (optional) the percentage of variation. By default, is 0.1
         */
    ...
    */
    ...
    /**
       ...
       set equal to a random number uniformuely distributed between [xp,p],
       where p is the minimum interarrival time.
    */
